 ...
 */
final class Version20230318153012 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE audio_records (id INT AUTO_INCREMENT NOT NULL, artist_id_id INT NOT NULL, kind_id INT DEFAULT NULL, voice_style_id INT NOT NULL, uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', title VARCHAR(255) NOT NULL, length INT NOT NULL, number_of_plays INT NOT NULL, number_of_moons INT NOT NULL, description LONGTEXT NOT NULL, created_at VARCHAR(255) NOT NULL, updated_at VARCHAR(255) NOT NULL, INDEX IDX_A32A519A1F48AE04 (artist_id_id), INDEX IDX_A32A519A30602CA9 (kind_id), INDEX IDX_A32A519AD392D671 (voice_style_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
