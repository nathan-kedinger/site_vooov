 ...
 */
final class Version20230321073801 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE audio_records (id INT AUTO_INCREMENT NOT NULL, artist_id_id INT NOT NULL, categories_id INT DEFAULT NULL, voice_style_id INT NOT NULL, uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', title VARCHAR(255) NOT NULL, length INT NOT NULL, number_of_plays INT NOT NULL, number_of_moons INT NOT NULL, description LONGTEXT NOT NULL, created_at VARCHAR(255) NOT NULL, updated_at VARCHAR(255) NOT NULL, INDEX IDX_A32A519A1F48AE04 (artist_id_id), INDEX IDX_A32A519AA21214B7 (categories_id), INDEX IDX_A32A519AD392D671 (voice_style_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE offers (id INT AUTO_INCREMENT NOT NULL, user_id_id INT NOT NULL, uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', title VARCHAR(255) NOT NULL, body LONGTEXT NOT NULL, budget INT NOT NULL, voice_type VARCHAR(255) NOT NULL, accomplished TINYINT(1) NOT NULL, created_at VARCHAR(255) NOT NULL, end_at DATETIME NOT NULL, INDEX IDX_DA4604279D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
